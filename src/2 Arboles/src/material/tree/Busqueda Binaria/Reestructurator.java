...
class Reestructurator {
    /**
     * Performs a tri-node restructuring. Recieves the x node and assumes 
     * the nodes are in one of following configurations:
     *
     * <pre>
     *          z=c       z=c        z=a         z=a
     *         /  \      /  \       /  \        /  \
    ...
    public Position restructure(Position posNode, LinkedBinarySearchTree binTree) {
        LinkedBinarySearchTree lowKey, midKey, highKey, t1, t2, t3, t4;
